...
plot "test-deconvolution-85.csv" using (($1)/3600):(1000*($8)) with lines linestyle 5 ti "Hf1", \
 "test-deconvolution-85.csv" using (($1)/3600):(1000*($9)) with lines linestyle 4 ti "Hf2", \
 "test-deconvolution-85.csv" using (($1)/3600):(1000*($10)) with lines linestyle 3 ti "Hf3", \
 "test-deconvolution-85.csv" using (($1)/3600):(1000*($11)) with lines linestyle 1 ti "Hf", \

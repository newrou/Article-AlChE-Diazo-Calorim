...
plot "test-deconvolution-80.csv" using (($1)/3600):(1000*($8)) with lines linestyle 4 ti "P1", \
 "test-deconvolution-80.csv" using (($1)/3600):(1000*($9)) with lines linestyle 3 ti "P2", \
 "test-deconvolution-80.csv" using (($1)/3600):(1000*($10)) with lines linestyle 1 ti "P_{Sum}", \
 "o-NO2-Ph-N2-OTf-80.dat" using (($1)/3600):(1000*($5)) with lines linestyle 2 ti "P_{Exp}"

set output "test-deconvolution-80-black.svg"
...
plot "test-deconvolution-80.csv" using (($1)/3600):(1000*($8)) with lines linestyle 4 ti "P_1", \
 "test-deconvolution-80.csv" using (($1)/3600):(1000*($9)) with lines linestyle 3 ti "P_2", \
 "test-deconvolution-80.csv" using (($1)/3600):(1000*($10)) with lines linestyle 1 ti "P_{Sum}", \
 "o-NO2-Ph-N2-OTf-80.dat" using (($1)/3600):(1000*($5)) with lines linestyle 2 ti "P_{Exp}"

...
set label "(1c)" at 5,100
set label "(1d)" at 30,8
set key samplen -1 spacing 1.3 font ",26" box lw 0
plot "Ampoule (8-15-16) p-NO2-Ph-N2-OTf-85.dat" using (($1)/3600):(1000*($5)) with lines linestyle 2 ti " 4-NO_2C_6H_4N@_2^+ TfO^- (1c)", \
     "Ampoule (1-12-16) p-CH3O-Ph-N2-OTf-85.dat" using (($1)/3600):(1000*($5)) with lines linestyle 1 ti " 4-CH_3OC_6H_4N@_2^+ TfO^- (1d)"

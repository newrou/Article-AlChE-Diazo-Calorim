...
plot "Ampoule (1-12-16) p-CH3O-Ph-N2-OTf-85.dat" using (($1)/3600):(1000*($5)) with lines linestyle 1 ti " 4-CH_3O-Ph-N@_2^+ ^-OTf (1d)", \
 "Ampoule (8-15-16) p-NO2-Ph-N2-OTf-85.dat" using (($1)/3600):(1000*($5)) with lines linestyle 2 ti " 4-NO_2-Ph-N@_2^+ ^-OTf (1c)"

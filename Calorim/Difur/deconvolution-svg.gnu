...
set output "deconvolution.svg"
plot "deconvolution.csv" using (($1)/3600):(1000*($8)) with lines linestyle 1 ti "Hf1", \
 "deconvolution.csv" using (($1)/3600):(1000*($9)) with lines linestyle 3 ti "Hf2", \
 "deconvolution.csv" using (($1)/3600):(1000*($10)) with lines linestyle 2 ti "Hf"
